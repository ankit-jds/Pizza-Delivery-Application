...
const courier = CourierClient({ authorizationToken: "pk_prod_6ZHRBMMT76454JGVAXRHG71PFGZ7" });
...
export const create_new_user = [
    ...
    body('password', "Password Length should be greater than 6").trim().isLength({ min: 6 }).escape(),
    async (req, res) => {
        // Check if password is equal to confirm_password
        (await body('confirm_password').trim()
...
export const reset_password_link = [
    ...
    async (req, res) => {
        ...
        res.send("The reset password link is being sent to your reegistered email ID.");

    }
]

export const update_password = [
    body('new_password', "Password Length should be greater than 6").trim().isLength({ min: 6 }).escape(),
    async (req, res) => {
        // Check if password is equal to confirm_password
        (await body('confirm_new_password').trim()
